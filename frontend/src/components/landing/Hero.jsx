...
export default function Hero() {
  ...
  return (
    <section
      id="home"
      className="bg-gradient-to-br from-white via-violet-50 to-blue-50 py-10 font-serif"
    >
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          >
            ...
            <p className="mt-8 text-xl text-black-600">
            ...
            <div className="mt-10 flex gap-4">
              <button
                ...
                className="bg-red-600 text-white px-5 p-4 rounded-xl"
              >
                Get Started
              </button>
            </div>
